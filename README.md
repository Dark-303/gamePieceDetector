...
|--------|----------------|----------------|-------|
| **VER 1.3** | [coral_modelVER1.3](https://github.com/Dark-303/gamePieceDetector/blob/main/coral2025FRCTrainer/versions/coral_modelVER1.3/coral_modelVER1.3.pt) | 450 epochs | Best on carpet |
| **VER 0.3** | [coral_modelVER0.3](https://github.com/Dark-303/gamePieceDetector/blob/main/coral2025FRCTrainer/versions/coral_modelVER0.3/coral_modelVER0.3.pt) | 100 epochs | Detects coral only horizontally |
| **VER 1.2** | [coral_modelVER1.2](https://github.com/Dark-303/gamePieceDetector/blob/main/coral2025FRCTrainer/versions/coral_modelVER1.2/coral_modelVER1.2.pt) | 150 epochs | Detects most positions but may pick up on other objects |
